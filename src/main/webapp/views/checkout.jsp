...
<head>
  ...
  <style>
    ...
    .checkout-box-title i { color: var(--primary); font-size: 17px; }

    .form-fields-stack { display: flex; flex-direction: column; gap: var(--space-lg); }
    ...
    .payment-option:hover { border-color: rgba(255,107,53,0.35); }
    .payment-option input[type="radio"] { accent-color: var(--primary); width: 16px; height: 16px; }
    .payment-option label { cursor: pointer; font-size: 14px; font-weight: 600; color: var(--text-secondary); flex: 1; }
    .payment-option i { font-size: 20px; color: var(--text-faint); }
    ...
    .order-item-name { color: var(--text-secondary); font-weight: 500; flex: 1; }
    .order-item-qty { color: var(--text-faint); font-size: 12px; margin: 0 var(--space-sm); }
    .order-item-price { color: var(--primary); font-weight: 700; white-space: nowrap; }
    ...
    .order-total-label { font-size: 16px; font-weight: 700; color: var(--text-secondary); }
    .order-total-value {
      font-family: var(--font-display);
      font-size: 28px;
    ...
    .state-box p { font-size: 15px; color: var(--text-muted); margin-bottom: var(--space-xl); }
...
<div class="page-wrapper">
  ...
  <div class="page-main">
    <div class="container" style="padding-top:var(--space-2xl); padding-bottom:var(--space-3xl);">
      ...
      <!-- Steps bar -->
      <div class="steps-bar">
        <div class="step-item done"><div class="step-num"><i class="fa-solid fa-check" style="font-size:10px;"></i></div> Giỏ Hàng</div>
        <div class="step-item active"><div class="step-num">2</div> Thanh Toán</div>
        <div class="step-item"><div class="step-num">3</div> Hoàn Thành</div>
      </div>
          ...
          <form action="${pageContext.request.contextPath}/checkout" method="POST" class="checkout-grid">
            ...
            <div class="checkout-box">
              ...
              <div class="form-fields-stack">
                ...
                <div class="form-group">
                  <label class="form-label" style="margin-bottom:var(--space-md);">Phương Thức Thanh Toán</label>
                  <div class="payment-options">
                    <div class="payment-option">
                      <input type="radio" name="paymentMethod" id="pm-cod"
                             value="Tiền mặt (COD)" checked>
                      <i class="fa-solid fa-money-bill-wave"></i>
                      <label for="pm-cod">Thanh toán khi nhận hàng (COD)</label>
                    </div>
                    <div class="payment-option">
                      <input type="radio" name="paymentMethod" id="pm-card"
                             value="Thẻ Visa/Mastercard">
                      <i class="fa-solid fa-credit-card"></i>
                      <label for="pm-card">Thẻ Visa / Mastercard</label>
                    </div>
                    <div class="payment-option">
                      <input type="radio" name="paymentMethod" id="pm-momo"
                             value="Ví MoMo">
                      <i class="fa-solid fa-wallet"></i>
                      <label for="pm-momo">Ví MoMo</label>
                    </div>
                    <div class="payment-option">
                      <input type="radio" name="paymentMethod" id="pm-transfer"
                             value="Chuyển khoản">
                ...
                <div style="margin-top:var(--space-sm); padding:14px 16px; background:rgba(0,214,127,0.06); border:1px solid rgba(0,214,127,0.2); border-radius:var(--radius-md); display:flex; align-items:center; gap:10px; font-size:13px; color:var(--success);">
            ...
            <div class="order-summary-card">
              ...
              <button type="submit" class="btn btn-primary btn-full btn-xl btn-shimmer" style="margin-top:var(--space-xl);">
                <i class="fa-solid fa-check-circle"></i> Xác Nhận Đặt Hàng
              </button>

              <a href="${pageContext.request.contextPath}/cart"
                 class="btn btn-secondary btn-full btn-md" style="margin-top:var(--space-sm);">
                <i class="fa-solid fa-arrow-left"></i> Quay Lại Giỏ Hàng
              </a>
            </div>
