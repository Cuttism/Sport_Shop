...
<head>
  ...
  <title>SportShop - Sản Phẩm | Cửa Hàng Thể Thao</title>
...
<div class="page-wrapper">
  ...
  <nav class="navbar">
    ...
    <div class="nav-links">
      ...
      <a href="${pageContext.request.contextPath}/products" class="active">Sản Phẩm</a>
  ...
  <div class="page-main">
    ...
    <!-- Hero section removed for products page -->
    ...
    <!-- Promo banner removed for products page -->
