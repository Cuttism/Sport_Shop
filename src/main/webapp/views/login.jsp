...
<head>
  ...
  <style>
    ...
    @media (max-width: 900px) {
      ...
      .auth-hero { flex: none; min-height: 300px; padding: 40px 24px; }
  ...
  <div class="auth-form-panel">
    <div class="auth-form-container">
      ...
      <div class="demo-box">
        ...
        <div class="demo-item">
          <span class="demo-item-role">Nhân viên kho</span>
          <code class="demo-item-code" onclick="fillDemo('NVK01')">NVK01</code>
        </div>
        <div class="demo-item">
